...
category_bp.route('/api/categories',                          methods=['GET'])(ctrl.list_categories)
category_bp.route('/api/categories',                          methods=['POST'])(ctrl.add_category)
category_bp.route('/api/categories/<int:id>',                 methods=['PUT'])(ctrl.update_category)
category_bp.route('/api/categories/<int:id>',                 methods=['DELETE'])(ctrl.delete_category)
