...
category_bp.route('/api/categories/upload-icon',              methods=['POST'])(token_required(ctrl.upload_category_icon))
category_bp.route('/static/uploads/category-icons/<filename>', methods=['GET'])(ctrl.serve_category_icon)
...
category_bp.route('/api/categories/<int:id>/bucket',          methods=['POST'])(token_required(ctrl.set_category_bucket))
