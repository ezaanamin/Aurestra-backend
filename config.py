...
# === BANK CONFIG ===
# === BANK CONFIG ===
BANK_EMAIL_ACCOUNT = os.getenv("BANK_EMAIL_ACCOUNT", "ezaan.amin@gmail.com").strip()
_RAW_APP_PASSWORD = os.getenv("APP_PASSWORD", "").replace(" ", "").strip()
APP_PASSWORD = _RAW_APP_PASSWORD
# Fallback to APP_PASSWORD if specific ones are missing
BANK_APP_PASSWORD = os.getenv("BANK_APP_PASSWORD", "").replace(" ", "").strip() or APP_PASSWORD
...
# === WALLET CONFIG ===
WALLET_APP_PASSWORD = os.getenv("WALLET_APP_PASSWORD", "").replace(" ", "").strip() or APP_PASSWORD
